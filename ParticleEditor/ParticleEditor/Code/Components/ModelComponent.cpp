...
void ModelComponent::InitGrid(unsigned int size)
{
	...
	{
		vertices[(i * 4) + 0].position = XMFLOAT3(-topLeft + horizontalCount, 0.0f, topLeft - verticalCount);
		...
		vertices[(i * 4) + 1].position = XMFLOAT3((-topLeft + horizontalCount) + 1, 0.0f, topLeft - verticalCount);
		...
		vertices[(i * 4) + 2].position = XMFLOAT3(-topLeft + horizontalCount, 0.0f, topLeft - (1 + verticalCount));
		...
		vertices[(i * 4) + 3].position = XMFLOAT3((-topLeft + horizontalCount) + 1, 0.0f, topLeft - (1 + verticalCount));
	...
	_mesh->CreateBuffers(vertices, indices, 4 * (size * size), 6 * (size * size));
