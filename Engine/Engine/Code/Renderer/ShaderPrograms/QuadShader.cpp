...
{
	// create quad shaders
	SHADER_HELPERS::CreateVertexShader(L"shaders/vertexQuad.hlsl", _vertexShader, vertexShaderByteCode);
	SHADER_HELPERS::CreatePixelShader(L"shaders/pixelQuad.hlsl",   _pixelShader,  pixelShaderByteCode);
